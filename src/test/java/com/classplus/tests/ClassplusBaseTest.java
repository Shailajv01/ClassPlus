...
public class ClassplusBaseTest {
	...
	private static final Logger logger = Logger.getLogger(ClassplusBaseTest.class);
	protected static String browserDriverPath = null;
	// protected LoginPage loginpage = null;
	protected ClassplusLoginPage classplusloginpage = null;
	protected ClassplusLoginPage facultyloginpage = null;
	protected ClassplusLoginPage studentloginpage = null;
	protected MyCourcesPage mycourcespage = null;
	protected WebDriver driver = null;
	protected WebDriver facultyDriver = null;
	protected WebDriver studentDriver = null;
	protected CreateCourseWithDataProvider createCourseWithDataProvider=null;

	protected enum WEB_DRIVER {

		LOGIN_DRIVER, FORGOT_PASSWORD_DRIVER, BUY_INVESTMENT_DRIVER, STOREHOME_DRIVER_TEST,
		STOREHOME_FACULTYDRIVER_TEST, STOREHOME_STUDENTDRIVER_TEST, studentDriver,facultyDrivers,COURSECREATION_DRIVER_TEST,STUDENT_COURSECREATION_DRIVER_TEST;
	}
	...
	protected synchronized void quitDriver(WebDriver driver2, WEB_DRIVER webDriver) {
	...
	protected void goToSite( WebDriver driver, String siteURL) throws Exception {
	  ...
	  public void loginToApplication(ClassplusLoginPage classplusloginpage, WebDriver driver,
			  String orgCode, String mobileNumber, String otp) {
	  
		  	classplusloginpage.setOrgCode(orgCode);
			classplusloginpage.setMobileNumber(mobileNumber);
			classplusloginpage.clickOnProceedSecurelyBtn();
			classplusloginpage.setOtp(otp);
			classplusloginpage.clickOnVerifyOtp();
	  }
